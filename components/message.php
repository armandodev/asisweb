<?php if (isset($_SESSION['message'])) { ?>
  <div class="flex justify-center absolute top-0 left-0 w-full h-screen z-10">
    <?php if ($_SESSION['message']['type'] === 'error') {
      ...
      echo '<div class="bg-green-400 text-green-950 w-[90%] max-w-xl border border-green-950 rounded-lg m-auto p-3 absolute bottom-3 flex items-center justify-between gap-2 border-b-0" id="message" open>';
      echo '
      ...
      echo '<div class="bg-yellow-300 text-yellow-950 w-[90%] max-w-xl border border-yellow-950 rounded-lg m-auto p-3 absolute bottom-3 flex items-center justify-between gap-2 border-b-0" id="message" open>';
      echo '
      ...
      echo '<div class="bg-blue-300 text-blue-950 w-[90%] max-w-xl border border-blue-950 rounded-lg m-auto p-3 absolute bottom-3 flex items-center justify-between gap-2 border-b-0" id="message" open>';
      echo '
